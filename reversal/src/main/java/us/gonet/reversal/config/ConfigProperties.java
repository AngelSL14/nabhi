...
public class ConfigProperties {
    ...
    public void config(){
        final String jpa = props.getProtocol() + props.getJdbHost() +  ":" + props.getJdbPort() + props.getJdbPath();
        final String iso = props.getProtocol() + props.getIsoHost() +  ":" + props.getIsoPort() + props.getIsoPath();
        final String jke = props.getProtocol() + props.getJkeHost() +  ":" + props.getJkePort() + props.getJkePath();
        final String rcpt = props.getProtocol() + props.getRcptHost() +  ":" + props.getRcptPort() + props.getRcptPath();
