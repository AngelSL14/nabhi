...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure ( HttpSecurity http ) throws Exception {
        ...
        http.cors().and()
                ...
                .antMatchers( HttpMethod.POST, URL ).permitAll()//Permitimos acceso al login a cualquiera
                .antMatchers( HttpMethod.POST, "/capa/publicity" ).permitAll()//Permitimos acceso al login a cualquiera
                .antMatchers( HttpMethod.POST, "/capa/bilities" ).permitAll()//Permitimos acceso al login a cualquiera
